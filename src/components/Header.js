              ...
              {isDropdownOpen && (
                ...
                >
                  <div className="py-1">
                    ...
                    <Link href="/#partners" className="block px-4 py-2 text-gray-300 hover:text-white hover:bg-pink-900/30 transition-colors">
                      Partners
                    </Link>
                  </div>
                </motion.div>
           ...
           >
              <div className="bg-black/90 backdrop-blur-md border border-pink-500/30 rounded-2xl p-6 shadow-2xl flex flex-col space-y-4 text-center">
                 <div className="flex flex-col space-y-2">
                    ...
                    <Link href="/#partners" onClick={toggleMobileMenu} className="text-gray-300 hover:text-white">Partners</Link>
                 </div>
