                ...
                <section className="h-96 flex items-center justify-center px-8">
                    ...
                    <div className="max-w-4xl text-center space-y-8">
                        <p className="text-lg text-gray-300">
                            Quantum Art - New Media Project 2    </p>
                            <p className="text-lg text-gray-300">
                            Our team from TU Delft and KABK, in collaboration with QuTech, Laurens Feije, and Gerben Timmer, is crafting a revolutionary artistic medium. Seamlessly blending advanced technology and profound messaging, our creation promises to demystify quantum concepts for all.  </p>
                    </div>
                </section>
